 ...
 *
 * <p>Produced by {@link RuleEngine#evaluate(za.co.fraudruleengine.domain.model.Transaction)}
 * and consumed by {@link za.co.fraudruleengine.application.FraudEvaluationService}, which uses
...
public record EvaluationResult(List<RuleResult> ruleResults, int totalScore) {
     ...
     *
     * <p>This list is stored on the resulting {@link za.co.fraudruleengine.infrastructure.persistence.entity.FraudAlertEntity}
