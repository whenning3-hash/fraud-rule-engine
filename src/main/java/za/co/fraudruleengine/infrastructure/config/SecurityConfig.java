 ...
 * </ul>
 *
 * <p>The following paths are always publicly accessible regardless of the security toggle:
 * <ul>
 *   <li>{@code /api/v1/auth/**} — token issuance endpoint</li>
 *   <li>{@code /swagger-ui/**}, {@code /api-docs/**} — OpenAPI documentation</li>
