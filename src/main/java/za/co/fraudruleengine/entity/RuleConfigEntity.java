 ...
 *
 * <p>Each row corresponds to one {@link za.co.fraudruleengine.rule.FraudRule} implementation
 * and is identified by its {@code rule_name}, which must exactly match the value returned by
 * {@link za.co.fraudruleengine.rule.FraudRule#getRuleName()}.
 *
 ...
 * {@link za.co.fraudruleengine.rule.RuleEngine} fetches configuration fresh on every
 * evaluation.
 *
...
public class RuleConfigEntity {
    ...
    /**
     * The canonical rule identifier that links this config to its {@link za.co.fraudruleengine.rule.FraudRule}
     ...
     * Values are always stored as strings and parsed by {@link za.co.fraudruleengine.rule.RuleParameters}.
     */
